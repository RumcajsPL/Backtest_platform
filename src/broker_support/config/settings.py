"""
Application settings — loaded from broker_settings.env via pydantic-settings.
Single source of truth for all configuration. No module loads its own config.
"""
...
class Settings(BaseSettings):
    ...
    etoro_base_url: str = Field(
        "https://public-api.etoro.com", validation_alias='ETORO_BASE_URL'
    )
    ...
    model_config = {
        "env_file": "configs/broker_support/broker_settings.env",
...
# Global settings instance — imported by all modules
settings = Settings()